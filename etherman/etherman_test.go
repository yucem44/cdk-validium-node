...
func TestSequencedBatchesEvent(t *testing.T) {
	...
	sequences = append(sequences, cdkvalidium.PolygonDataComitteeValidiumBatchData{
		GlobalExitRoot:     ger,
	...
	_, err = etherman.CDKValidium.SequenceBatchesDataCommittee(auth, sequences, auth.From, []byte{})
	require.NoError(t, err)
...
func TestVerifyBatchEvent(t *testing.T) {
	...
	rawTxs := ""
	tx := cdkvalidium.PolygonDataComitteeValidiumBatchData{
		GlobalExitRoot:     common.Hash{},
		Timestamp:          initBlock.Time(),
		MinForcedTimestamp: 0,
		TransactionsHash:   crypto.Keccak256Hash(common.Hex2Bytes(rawTxs)),
	}
	_, err = etherman.CDKValidium.SequenceBatchesDataCommittee(auth, []cdkvalidium.PolygonDataComitteeValidiumBatchData{tx}, auth.From, []byte{})
	require.NoError(t, err)
...
func TestSequenceForceBatchesEvent(t *testing.T) {
	...
	forceBatchData := cdkvalidium.PolygonRollupBaseForcedBatchData{
	...
	_, err = etherman.CDKValidium.SequenceForceBatches(auth, []cdkvalidium.PolygonRollupBaseForcedBatchData{forceBatchData})
	require.NoError(t, err)
	ethBackend.Commit()
